# Phase 4 R Scripts Batch Runner - IMMEDIATE Level
# Run all Phase 4 heterogeneity/stratification R scripts for immediate exposure
...
Write-Host "  Phase 4 R Scripts - IMMEDIATE Level" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Exposure level: IMMEDIATE" -ForegroundColor Yellow
Write-Host ""
...
foreach ($script in $phase4Scripts) {
    ...
    Write-Host "[$currentScript/$totalScripts] Running: $scriptName immediate" -ForegroundColor Green
    ...
    if (Test-Path $scriptPath) {
        ...
        # Run the R script with "immediate" argument
        & $Rscript $scriptPath immediate
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  BATCH COMPLETE (IMMEDIATE)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
