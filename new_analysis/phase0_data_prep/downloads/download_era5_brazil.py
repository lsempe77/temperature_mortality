"""
Download ERA5 temperature and related variables for Brazil (2021-2024)
...
def download_era5_brazil():
    """Download ERA5 data for Brazil from 2021 to 2024."""
    ...
    print("=" * 60)
    print("Downloading ERA5 data for Brazil (2021-2024)")
    ...
    print("=" * 60)
    print("\nFiles created for each year (2021-2024):")
